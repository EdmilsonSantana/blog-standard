    ...
    <div className="overflow-auto h-full">
      <div className="max-w-screen-sm mx-auto">
        ...
        <div className="my-4">
          ...
          {showDeleteConfirm && (
            <div>
              <p className="p-2 bg-red-300 text-center">Are you sure you want delete this post? This action is irreversible</p>
  ...
  async getServerSideProps(ctx) {
    ...
    return {
      props: {
        ...
        metaDescription: post.metaDescriptionContent,
